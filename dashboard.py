...
Design contract:
  ...
  * Every number shown is either:
    ...
    (b) recomputed live and verified bitwise-identical to frozen stage-4 reports, or
...
def compute_frontier():
    ...
    Bitwise identical to the frozen report (thresholds 0.20/0.48, argmin line -327,071)."""
...
def view_frontier():
    ...
    st.markdown(
        ...
        "This chart is recomputed live in your browser from the frozen artifacts — bitwise-identical to the audited stage-4 report.</div>",
        unsafe_allow_html=True)
